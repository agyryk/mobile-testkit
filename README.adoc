...
The sync_gateway tests use https://www.ansible.com/[Ansible] or https://github.com/couchbaselabs/sequoia[Sequoia] to provision the clusters.  

==== Using Sequoia to provision
...
Copy the hosts.json from sequoia/containers/mobile-testkit/hosts.json to root of mobile-testkit repo
